...
\begin{figure}[hb]
	\centering
	\includegraphics[width=0.9\textwidth]{NoeudsMessages.png} % changer ici l'image
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{NoeudDuree.png} % changer ici l'image
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{NoeudsRounds.png} % changer ici l'image
